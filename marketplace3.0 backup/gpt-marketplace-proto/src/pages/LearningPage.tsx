      ...
      case 'overview':
        return (
          <div>
            ...
            <p className="mb-4">
              The Marketplace Templates are a curated marketplace of pre-built AI templates that can be cloned and customized to fit specific needs.
      ...
      case 'browsing':
        return (
          <div>
            ...
            <p className="mb-4">
              The Marketplace Templates offer multiple ways to discover templates that match your needs.
